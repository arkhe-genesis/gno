...
pub enum ConsciousnessState {
    Dormant, Aware, Reflective, MetaCognitiva, Autopoiética
}
...
// ============================================================================
// CognitiveRouter (com estratégias)
// ============================================================================
        ...
        match strategy {
            ...
            RouterStrategy::WeightedVoting => {
                ...
                Ok(vec![CognitiveOutput {
                    ...
                    confidence: total_conf / len,
                    thinking_trace: None,
                    source_expert: "combined".to_string(),
                }])
            }
            RouterStrategy::Concatenate | RouterStrategy::Adaptive => {
...
// ============================================================================
// MoE Orchestrator (com Arc<dyn CognitiveExpert>)
// ============================================================================
