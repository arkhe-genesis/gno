...
# Mock da biblioteca pyrfc para evitar erros de importação se não estiver instalada.
# Em produção, a biblioteca original deve ser utilizada.
class MockConnection:
    def __init__(self, **kwargs):
        pass
    def call(self, func_name, **kwargs):
        return {'HEADER': {}, 'ITEMS': [{'AMOUNT': '100.00'}]}
